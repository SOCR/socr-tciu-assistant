  ...
  */
  ...
  return (
    <div className="relative w-full flex flex-col gap-4 mb-4">
      {messages.length === 0 && (
        // Remove attachments check from condition
      ...
      */}
      ...
      <Textarea
        ...
        className={cx(
          'min-h-[24px] max-h-[calc(75dvh)]  overflow-hidden resize-none rounded-2xl shadow-md !text-base bg-white pb-10 dark:bg-zinc-900 dark:border-zinc-700 w-full',
          className,
        )}
        rows={2}
        // autoFocus
