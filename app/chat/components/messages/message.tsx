            ...
            // <div className="size-8 flex items-center rounded-full justify-center ring-1 shrink-0 ring-border bg-background">
              <div className="translate-y-px">
                ...
                <div className="flex rounded-full items-center gap-2">
                  {/* <span className="text-lg bg-white drop-shadow-md border border-gray-200 rounded-full font-semibold">
                    <Image src="/socr_logo.png" alt="logo" width={32} height={32} />
                  </span> */}
                </div>
              {/* </div> */}
            </div>
            ...
            {message.parts?.map((part, index) => {
              ...
              if (type === 'tool-invocation') {
                ...
                if (state === 'call') {
                  ...
                  return(
                    <div key={toolCallId}>
                      <p className='text-sm text-muted-foreground'>Searching TCIU knowledge base for {args.query}</p>
                    </div>
                  )
