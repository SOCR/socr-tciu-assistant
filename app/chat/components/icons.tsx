...
// Simple icon components used by the MultimodalInput
...
export const StopIcon = ({ size = 16, ...props }: LucideProps) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 24 24"
    width={size}
...
export const PaperclipIcon = ({ size = 16, ...props }: LucideProps) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 24 24"
    width={size}
  ...
  >
    <defs>
      <linearGradient id="sparkleGradient" x1="0%" y1="0%" x2="100%" y2="100%">
        ...
        <stop offset="100%" style={{ stopColor: 'purple', stopOpacity: 0.8 }} />
      </linearGradient>
    </defs>
    <path
